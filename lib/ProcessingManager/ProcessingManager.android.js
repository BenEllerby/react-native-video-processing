...
export class ProcessingManager {
  ...
  static watermark(source: sourceType, watermarkSource: sourceType): Promise<*> {
    const actualSource: string = getActualSource(source);
    const actualWatermarkSource: string = getActualSource(watermarkSource);
    return TrimmerManager.watermark(actualSource, actualWatermarkSource)
      .then((res) => res.source);
  }
